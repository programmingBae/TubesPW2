...
{{-- main content here --}}
<form method="POST" action='{{route('penerimaSave')}}'>
    @csrf
    <div style="margin-left: 10px; margin-top:15px" class="form-group">
        <label id='txtNameId' for="txtName">Name</label>
        <input type="text" class="form-control" id="txtName" name="nama" placeholder="Enter Supplier Name" required>
        <label id='txtTelpId' for="txtTelp">Telp</label>
        <input type="text" class="form-control" id="txtTelp" name="no_telp" placeholder="Enter Supplier Telp" required>
        <label id='txtAlamatId' for="txtAlamat">Alamat</label>
        <input type="text" class="form-control" id="txtAlamat" name="alamat" placeholder="Enter Supplier Alamat" required>
    </div>
